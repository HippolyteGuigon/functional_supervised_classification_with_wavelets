...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \emph{Parcimonie.} Toute courbe utilise strictement moins de $p/c^2$ fonctions de base : $\sum_{j=1}^ps_j(\bx;c)<p/c^2$ pour tout $\bx$. Par conséquent $\sum_j\hphi_j(c)<p/c^2$ et, pour tout $\alpha\in\,]0,1]$,
  \[
...
Concentration du classement & moments d'ordre $\ge2$ requis & exponentielle, sans hypothèse \\
